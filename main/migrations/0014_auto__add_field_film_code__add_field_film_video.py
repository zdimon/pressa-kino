...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.code'
        db.add_column(u'main_film', 'code',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Film.video'
        db.add_column(u'main_film', 'video',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.code'
        db.delete_column(u'main_film', 'code')

        # Deleting field 'Film.video'
        db.delete_column(u'main_film', 'video')
