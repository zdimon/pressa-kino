...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Videos'
        db.create_table(u'main_videos', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Film'])),
        ...
        db.send_create_signal(u'main', ['Videos'])


    def backwards(self, orm):
        # Deleting model 'Videos'
        db.delete_table(u'main_videos')
