...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.cropping'
        db.add_column(u'main_film', 'cropping',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Page.in_menu'
        db.add_column(u'main_page', 'in_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.cropping'
        db.delete_column(u'main_film', 'cropping')

        # Deleting field 'Page.in_menu'
        db.delete_column(u'main_page', 'in_menu')
