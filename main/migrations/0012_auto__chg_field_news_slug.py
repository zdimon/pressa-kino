...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'main_news', 'slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'News.slug'
        db.alter_column(u'main_news', 'slug', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))
